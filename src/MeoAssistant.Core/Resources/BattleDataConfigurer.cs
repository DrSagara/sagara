// <copyright file="BattleDataConfigurer.cs" company="MaaAssistantArknights">
...
namespace MeoAssistant.Core.Resources
{
    ...
    /// </summary>
    public class BattleDataConfigurer : AbstractConfigurer
    {
        /// <summary>
        /// The empty range.
        /// </summary>
        public static readonly BattleAttackRange EmptyRange =
            new() { Range = new Point[] { new() { X = 0, Y = 0 } } };
